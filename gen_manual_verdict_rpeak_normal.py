...
for file_number in file_numbers:
    ...
    blank=0
    try:
        df1=pd.read_csv('european-st-t-database-'+file_number+'extra2.csv')
        blank=1
    except Exception as e:
        print("File does not exist")
        print("create file")
        with open('european-st-t-database-'+file_number+'extra2.csv', 'w'):
                pass
    ...
    print("Saving file...")
    df2.to_csv('european-st-t-database-'+file_number+'extra2.csv', encoding='utf-8', index=False)
